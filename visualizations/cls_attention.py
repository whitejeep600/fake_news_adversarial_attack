...
# These efforts were discontinued after my advisor suggested the SHAP package.
...
def main(weights_path: Path, eval_split_path: Path):
...
if __name__ == "__main__":
    ...
    main(weights_path, eval_split_path)
